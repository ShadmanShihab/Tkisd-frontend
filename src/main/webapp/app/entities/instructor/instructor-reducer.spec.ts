...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTRUCTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_INSTRUCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSTRUCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSTRUCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSTRUCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSTRUCTOR actions', async () => {
      const expectedActions = [
        {
