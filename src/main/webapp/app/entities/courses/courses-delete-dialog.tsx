...
export const CoursesDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/courses' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tkisdApp.courses.delete.question">
        <Translate contentKey="tkisdApp.courses.delete.question" interpolate={{ id: coursesEntity.id }}>
